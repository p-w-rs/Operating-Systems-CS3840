...
extern int rptClock; // RPT clock
extern int uptClock; // UPT clock
...
int P4_main(int argc, char *argv[]) // project 5
{
    ...
    // start lc3 tasks
    loadLC3File("support_files/memtest.hex.txt");
    loadLC3File("support_files/crawler.hex.txt");
...
int P4_vmaccess(int argc, char *argv[])
{
    ...
    printf("\nclockRPT = %d, clockUPT = %d, Pages = %d", rptClock, uptClock, accessPage(0, 0, PAGE_GET_SIZE));
    return 0;
} // end P4_vmaccess
